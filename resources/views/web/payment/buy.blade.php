...
<div class="cart-box-main">
    <div class="container">
        ...
        @endguest
        <form novalidate action="{{route('stripe.post')}}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
            @csrf
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3 required">
                                <label for="cc-expiration">Expiration</label>
                                <input type="text" class="form-control card-expiry-year" id="cc-expiration" placeholder="" required>
                                <div class="invalid-feedback"> Expiration date required </div>
                            </div>
                            <div class="col-md-3 mb-3">
